...
<div class="main">
    <div class="details">
        <div class="recentCustomers">
            ...
            <table>
                <form action="/gp1/admin/AdminPassword.php" method="POST">
                    <br><br>
                    Reference : 
                ...
                if($num_rows>0){
                    while($row=mysqli_fetch_assoc($result)){
                        if($row[$selectedReferenceOption]==$selectedReferenceOptionInput && password_verify($currentPassword, $row['password'])){
                            $sql1 =  "update `admin` SET password= '$newPassword' where username='$selectedReferenceOptionInput'";
                    ...
                    if($f == false)
                    {  
                        echo '<div style="font-weight: bold; font-size: 18pt; color: rgba(248,46,11); background-color: rgb(250, 151, 151); text-align: center;">OOPS!!! Invalid Record...</div>';
                        echo "<br>";                    
                    }                      
                }
            }
