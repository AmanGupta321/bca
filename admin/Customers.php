     ...
     require("adminnavigationforpre.html");
        ...
        if(isset($_POST['submit'])){
          ...
          if (!$conn){
            ...
            $sql =  "INSERT INTO `register` (`firstName`, `lastName`, `dob`, `email`, `contact`, `aadhar`, `username`, `password`, `gender`, `address`) VALUES ('$name', '$lname', '$dob', '$email', '$contact','$aadhar', '$uname', '$hash', '$gender', '$address');";
...
<div class="main">
    <div class="details">            
        ...
        <div class="recentCustomers">
            ...
            <br>
                <form action="/gp1/admin/Customers.php" method="POST" >
                <input class="inputstyle" name="name" placeholder="First Name" type="text" required />
                <br />

                <input class="inputstyle" name="lName" placeholder="Last name" type="text" required />
                <br />
